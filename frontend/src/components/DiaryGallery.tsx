  ...
  const diaryComics: DiaryComic[] = [
    {
      ...
      panelCount: 6,
      thumbnailUrl:
        "https://images.unsplash.com/photo-1731661553530-9fa227db04ed?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3JuaW5nJTIwY29mZmVlJTIwc3VubGlnaHR8ZW58MXx8fHwxNzU4MjkxNjUwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      excerpt:
        "오늘은 정말 특별한 하루였다. 아침에 일어나서 창문을 열었는데 햇살이 너무 따뜻했다...",
      tags: ["일상", "행복", "카페"],
    },
    {
      id: "2",
      ...
      excerpt:
        "공원을 산책하며 가을 단풍을 구경했다. 나뭇잎들이 노랗고 빨갛게 물들어 있어서...",
      tags: ["가을", "산책", "자연"],
    },
    {
      id: "3",
      ...
      excerpt:
        "오랜만에 친구를 만나서 새로운 카페에 갔다. 그곳의 분위기가 너무 좋았고...",
      tags: ["친구", "카페", "대화"],
    },
    {
      id: "4",
      ...
      thumbnailUrl:
        "https://images.unsplash.com/photo-1731661553530-9fa227db04ed?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3JuaW5nJTIwY29mZmVlJTIwc3VubGlnaHR8ZW58MXx8fHwxNzU4MjkxNjUwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      excerpt:
        "집에서 조용히 차를 마시며 책을 읽었다. 창밖으로 보이는 저녁 노을이...",
      tags: ["평온", "독서", "저녁"],
    },
    {
      id: "5",
      ...
      thumbnailUrl:
        "https://images.unsplash.com/photo-1643983702094-9913662d8f43?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhdXR1bW4lMjBwYXJrJTIwd2Fsa3xlbnwxfHx8fDE3NTgyOTE2NTZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      excerpt:
        "오늘은 새로운 것에 도전해보았다. 처음에는 두려웠지만 막상 시작해보니...",
      tags: ["도전", "성장", "용기"],
    },
    {
      id: "6",
      ...
      thumbnailUrl:
        "https://images.unsplash.com/photo-1526865906320-0200a6e2c7f0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmcmllbmRzJTIwY2FmZSUyMGRlc3NlcnR8ZW58MXx8fHwxNzU4MjkxNjUzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      excerpt:
        "가족들과 함께 저녁을 먹으며 하루를 마무리했다. 오늘도 감사한 하루였다...",
      tags: ["가족", "저녁", "감사"],
    },
  ];

  const allTags = Array.from(
    new Set(diaryComics.flatMap((comic) => comic.tags)),
  );
  ...
  const filteredComics = diaryComics.filter((comic) => {
    const matchesSearch =
      ...
      comic.excerpt
        ...
        .includes(searchTerm.toLowerCase());
    const matchesTag =
      !selectedTag || comic.tags.includes(selectedTag);
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            지금까지 만든 {diaryComics.length}개의 일기 만화를
            확인해보세요
          </p>
        </div>

        <Button onClick={onCreateNew}>새 일기 작성하기</Button>
      </div>
